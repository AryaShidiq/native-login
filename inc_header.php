  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Login PHP Native </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if (in_array("guru",$_SESSION['admin_akses'])) { ?>
                        <li class="nav-item">
                            <a class="nav-link" href="admin_guru.php">Halaman Guru</a>
                        </li>
                    <?php }?>
                    <?php if (in_array("siswa",$_SESSION['admin_akses'])) { ?>
                        <li class="nav-item">
                            <a class="nav-link" href="admin_siswa.php">Halaman Siswa</a>
                        </li>
                    <?php }?>
                    <?php if (in_array("spp",$_SESSION['admin_akses'])) { ?>
                        <li class="nav-item">
                            <a class="nav-link" href="admin_spp.php">Halaman SPP</a>
                        </li>
                    <?php }?>
